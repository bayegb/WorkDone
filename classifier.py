...
# How to implement reguralisation?


# Seperate the X_train and X_Test into vectors of 784 elements, pixel values
...
# use numpy array for labels and vectors of the images 

# go through the neural network using ANN - feedforward algorithm
# ensure last activation function is able to deduce the digit?  